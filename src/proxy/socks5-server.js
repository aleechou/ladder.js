...
var Parser = require('socksv5/lib/server.parser'),
    ipbytes = require('socksv5/lib/utils').ipbytes;

var ATYP = require('socksv5/lib/constants').ATYP,
    REP = require('socksv5/lib/constants').REP;
